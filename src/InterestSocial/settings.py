# Django settings for InterestSocial project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'D:\\GikooProject\\Interest\\src\\InterestSocial\\sqlite.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '%q8r&oww9qf67r!y&7pk%gkt(^by*!6if&7_1$f4f@h8htd+9#'
...
WSGI_APPLICATION = 'InterestSocial.wsgi.application'
